<template>
  <v-app class="bg-surface">
    <v-card flat class="overflow-auto" style="width: 100vw; height: 85vh">
      <div style="max-width: 1200px; padding:25px">
        ...
        Figure out what your readers need most and make sure your developer home
        page answers it right from the start.
      </v-card-text>
      <v-card-text style="font-size: 25px">
        <h3>Delivery API</h3>
        The main and sub navigation also help developers zero in on the reason
      ...
      <v-card-text style="font-size: 25px" id="el1">
        ...
        Officiis facilis dicta esse molestias vero hic laudantium provident nisi
        eos quasi iusto alias sequi, aut aliquid voluptatibus commodi! Minima,
        eum voluptates?
      </v-card-text>
